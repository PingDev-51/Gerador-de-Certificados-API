...
using GeradorCertificados.Aplicacao;
using GeradorCertificados.Infraestrutura;
using GeradorCertificados.Infraestrutura.Compartilhado.Orm;
using GeradorCertificados.WebApi.Compartilhado.Auth;
using GeradorCertificados.WebApi.Compartilhado.Http;
using GeradorCertificados.WebApi.Compartilhado.Logging;
